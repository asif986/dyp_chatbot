...
export class RegisterPage implements OnInit {
  ...
  constructor(public alterctrl:AlertController,public loadingctr:LoadingController,public authservice:AuthService,
      ...
      this.authservice.register(this.email,this.password).then(res=>
        {
          ...
          this.afstore.collection('students').doc(uuid1.user.uid)
          .set(
            {
              user:this.name,
